...
public class Info {
	...
	public void setListFilesDataset() {
        ...
        for (int f = 0; f < files.length; f++) {
        	if(files[f].isFile() && files[f].getAbsolutePath().toString().endsWith(Config.InitialSettings.getFormatDataset()))
	...
	public Bitmap generateImageLearningCurve(AbsDatabase database) throws Exception {
        ...
        ChartView chartView = new ChartView(Config.Graphic.GRAPHIC_TYPE_LINE, chart );
        chartView.drawChart(chart);
        return ( (BitmapDrawable) chartView.getDrawable()).getBitmap();
	}

	public Bitmap generateImageErrorPrediction(AbsDatabase database) throws Exception {
		// TODO Auto-generated method stub
	...
	public Vector<Bitmap> generateImagesSchemesComparator(AbsDatabase database) throws Exception {
		// TODO Auto-generated method stub
		...
		ChartView chartView = new ChartView(Config.Graphic.GRAPHIC_TYPE_BAR, chart1);
...
public boolean saveSchemesComparatorImage(Bitmap img){
